...
// ============================================================================
// Comprehensive Disaster Management Tips Seeder
// Run with: node seeders/comprehensiveSeeder.js
// ============================================================================
...
async function seedDatabase() {
  try {
    ...
    // Clear existing data
    await disasterTip.deleteMany({});
    await quiz.deleteMany({});
    console.log('Cleared existing data');

    // Insert flood tips
    await disasterTip.create(disasterTips);
    console.log('Inserted floods tip');
